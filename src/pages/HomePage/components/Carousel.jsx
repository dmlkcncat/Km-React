...
const Carousel = () => {
  ...
  return <Swiper
    ...
    className="h-full"
  >
    {data.map(item => <SwiperSlide className="h-full">
      <div className="w-full h-full bg-gray-700 relative grid place-items-center z-0">
        <img src={item.img} className="absolute top-0 left-0 w-full h-full object-cover z-0 opacity-40 bg-blend-multiply" />
